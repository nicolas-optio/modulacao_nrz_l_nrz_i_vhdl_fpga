...
## ====================================================================
## PMOD HEADER JA (Linha Superior para o Analog Discovery 3)
## ====================================================================
# Pino 1 (JA1) - Fio Laranja/Branco (1+)
set_property PACKAGE_PIN J1 [get_ports {pmod_ja[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {pmod_ja[0]}]

# Pino 2 (JA2) - Fio Azul/Branco (2+) se for usar clock
...
## ====================================================================
## REGRAS DE TIMING CLOCK (Gated Clock)
## ====================================================================
